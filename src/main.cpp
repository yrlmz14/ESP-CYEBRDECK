...
void Core1(void * param)
{
  for(;;) 
  {
    ...
    Draw();
    display.drawString(String("Core 0 [")+fps+" fps]", 10,10,2);
    display.drawString(String("Core 1 [")+fps2+" fps]", 10,30,2);
    lcd_PushColors(0, 0, 320, 240, (uint16_t*)display.getPointer());
  }
}
